...
const ModulosPopup = ({ tabLabel, categoryKey, modulesData, lang, onClose }) => {
      ...
      <div className="mp-container" role="dialog" aria-modal="true" aria-label={tabLabel}>
        ...
        <div className={bodyClass}>
          ...
          <div className="mp-detail" ref={detailRef}>
            {detail ? (
              <>
                <button className="mp-back" onClick={() => setMobileView('list')} aria-label={lang === 'es' ? 'Volver a módulos' : 'Back to modules'}>
              ...
              <div className="mp-empty">
                ...
                <p>{lang === 'es' ? 'Selecciona un módulo para ver los detalles.' : 'Select a module to view details.'}</p>
              </div>
            )}
          </div>
