...
export const modulesDataES = {
  ...
  /* Onboarding desactivado temporalmente - descomentar para reactivar
  "Onboarding": {
    "Onboarding": {
  ...
  "Legajo de Clientes": {
    ...
    "Clientes Incompletos": {
      ...
      features: [
        ...
        "Identificación de documentación faltante, vencida, información pendiente y requisitos rechazados",
